...
class PopularMoviesViewModel(application: Application) : BaseAndroidViewModel(application) {
    ...
    fun loadPopularMovies(){
        ...
        repository.getAPI().getPopularMovies().enqueue(object: Callback<PopularMoviesModel> {
